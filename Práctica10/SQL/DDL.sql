...
-- Relacionar la tabla Atleta con Disciplina usando NombreDisciplina
-- Asegúrate de que la columna NombreDisciplina exista en la tabla Entrenador
ALTER TABLE Entrenador
ADD COLUMN NombreDisciplina VARCHAR(20);

-- Relacionar la tabla Atleta con Disciplina usando el campo Disciplina
ALTER TABLE Atleta
...
-- Relacionar la tabla Entrenador con Disciplina usando NombreDisciplina
ALTER TABLE Entrenador
...
ALTER TABLE Ganar
ADD COLUMN MedallaOro INT DEFAULT 0,
ADD COLUMN MedallaPlata INT DEFAULT 0,
ADD COLUMN MedallaBronce INT DEFAULT 0;
...
ALTER TABLE Evento
ADD COLUMN Precio NUMERIC(10,2) CHECK (Precio >= 0);
